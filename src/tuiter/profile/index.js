        ...
        <div className="row mt-2">
            <div className="border rounded px-0 py-3">
                ...
                <div className="row px-3 pb-1 bt-0">
                    <div className="col-3 small text-secondary"><i className="bi bi-geo-alt text-secondary pe-1"></i>{profile.location}</div>
                    <div className="col-3 small text-secondary"><i className="bi bi-balloon text-secondary pe-1"></i>Born {profile.dateOfBirth}</div>
                    <div className="col-4 small text-secondary"><i className="bi bi-calendar3 text-secondary pe-1"></i>Joined {profile.dateJoined}</div>
                </div>
                <div className="row px-3">
                    <div className="col-3">
